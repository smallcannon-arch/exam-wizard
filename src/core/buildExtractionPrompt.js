...
export const OBJECTIVE_EXTRACTION_RULES = [
  ...
  "學習目標文字必須照教案原文逐字擷取，不得改寫、增刪、潤飾或自行歸納。",
...
export const OBJECTIVE_EXTRACTION_OUTPUT_FORMAT =
  "請以 Markdown 表格輸出，欄位依序為：目標編號 | 大單元 | 小單元 | 學習目標 | 授課節數。不要輸出編號清單或額外說明文字。授課節數欄只填數字（如 1 或 0.5），不要加『節』等單位文字，也不要使用中文數字。註明事項請寫在所有資料列之後，以『註：』開頭。";
